        ...
        {samplePosts.map(post => (      
            <BoardList>
              ...
              <div className="commentWrap flex flex-ai-c">              
                {/* 좋아요 */}
                <div className="boardLike"><FontAwesomeIcon icon={faHeart} />{post.like}</div>
                {/* 코멘트 */}
                <div className="boardComment"><FontAwesomeIcon icon={faCommentAlt} /> {post.comments.length}</div>
              </div>                          
            </BoardList>       
        ))}
      </BoardWrap>
